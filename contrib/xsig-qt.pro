...
RESOURCES += src/qt/xsgt.qrc src/qt/xsgt_locale.qrc

TRANSLATIONS += src/qt/locale/xsgt_bg.ts \
                src/qt/locale/xsgt_de.ts \
                src/qt/locale/xsgt_en.ts \
                src/qt/locale/xsgt_es.ts \
                src/qt/locale/xsgt_fi.ts \
                src/qt/locale/xsgt_fr.ts \
                src/qt/locale/xsgt_it.ts \
                src/qt/locale/xsgt_ja.ts \
                src/qt/locale/xsgt_pl.ts \
                src/qt/locale/xsgt_pt.ts \
                src/qt/locale/xsgt_ru.ts \
                src/qt/locale/xsgt_sk.ts \
                src/qt/locale/xsgt_sv.ts \
                src/qt/locale/xsgt_vi.ts \
                src/qt/locale/xsgt_zh_CN.ts \
                src/qt/locale/xsgt_zh_TW.ts
