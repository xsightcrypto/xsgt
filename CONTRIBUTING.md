Contributing to xsightcoin Client
============================

The xsightcoin Client project operates an open contributor model where anyone is
...
The following applies to code changes to the xsightcoin Client project, and is not to be
confused with overall xsgt Network Protocol consensus changes.

Whether a pull request is merged into xsightcoin Client rests with the project merge
...
Patches that change xsgt consensus rules are considerably more involved than
...
Where a patch set proposes to change the xsgt consensus, it must have been
...
The project leader is the release manager for each xsightcoin Client release.
