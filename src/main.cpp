...
#if defined(NDEBUG)
#error "xsgt cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    else if (nHeight > 10 && nHeight <= 31 ) {
        nSubsidy = 450000 * COIN;
    } else if (nHeight > 31 && nHeight <= 5000 ) {  // Last POW Block
        nSubsidy = 0 * COIN;
    } else if (nHeight > 5000 && nHeight <= 7501 ) {
        nSubsidy = 2 * COIN;
    } else if (nHeight > 7501 && nHeight <= 93902 ) {
        nSubsidy = 50 * COIN;
    } else if (nHeight > 93902 && nHeight <= 353103 ) {
        nSubsidy = 35 * COIN;
    } else if (nHeight > 353103 && nHeight <= 612304 ) {
        nSubsidy = 24 * COIN;
    } else if (nHeight > 612304 && nHeight <= 871505 ) {
        nSubsidy = 17 * COIN;
    } else if (nHeight > 871505 && nHeight <= 1130706 ) {
        nSubsidy = 12 * COIN;
    } else if (nHeight > 1130706 && nHeight <= 1389907 ) {
        nSubsidy = 8 * COIN;
    } else if (nHeight > 1389907 && nHeight <= 1649108 ) {
        nSubsidy = 6 * COIN;
    } else if (nHeight > 1649108) {
        nSubsidy = 4 * COIN;
    }
return nSubsidy;
}
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    if (nHeight <= 4999) {
        ...
        int64_t mNodeCoins = mnodeman.size() * 35000 * COIN; // Collateral needed to run a single xsightcoin Masternode
