...
/** 
    ...
    ****Note - for xsgt we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of xsgt coming in to a transaction
