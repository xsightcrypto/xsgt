...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 52552;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // xsightcoin starting difficulty is the lowest possible 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60 * 60; // xsightcoin 1 hours
        nTargetSpacing = 1 * 60;  // xsightcoin Block Time: 1 Min
        nLastPOWBlock = 5000;   //Last Pow Block
        nMaturity = 20;
        nMasternodeCountDrift = 20;
        nModifierUpdateBlock = 615800;
        nMaxMoneyOut = 50000000 * COIN;

        const char* pszTimestamp = "Amazon’s 350,000 U.S. Workers Will Get a Minimum Wage of $15 // From NYT 2nd of October, 2018";
        ...
        strObfuscationPoolDummyAddress = "xfHFu9rJVKq5UCoUyjhDNZNfqmWPEpEDLz";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // xsightcoin: 1 day
        nTargetSpacing = 1 * 60;  // xsightcoin: 1 minute
        nLastPOWBlock = 100;
        nMaturity = 10;
        ...
        genesis.nTime = 1538504542;
        genesis.nNonce = 2419326;

        const int SCRYPT_SCRATCHPAD_SIZE = 131072 + 63;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0xe332bf41763f3abdc82367804e79201516bedb17df5c6cf758206ec270dc96ba"));

        vFixedSeeds.clear();
        vSeeds.clear();

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 137); // Testnet xsightcoin addresses start with 'x'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 8);  // Testnet xsightcoin script addresses start with '4'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 120);     // Testnet private keys start with 'q'
        // Testnet xsgt BIP32 pubkeys
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x61)(0x60)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet xsgt BIP32 prvkeys
        ...
        strObfuscationPoolDummyAddress = "xJiLtYVEby57cqfGRkekRyDRNvhXrNbmox";
        nStartMasternodePayments = 1538491339; //Tue, 02 Oct 2018 16:47:58 GMT
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // xsightcoin: 1 day
        nTargetSpacing = 1 * 60;        // xsightcoin: 1 minutes
