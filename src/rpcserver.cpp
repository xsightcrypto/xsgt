...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* xsgt features */
        {"xsgt", "masternode", &masternode, true, true, false},
        {"xsgt", "masternodelist", &masternodelist, true, true, false},
        {"xsgt", "mnbudget", &mnbudget, true, true, false},
        {"xsgt", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"xsgt", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"xsgt", "mnsync", &mnsync, true, true, false},
        {"xsgt", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"xsgt", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use xsgtd, or the -server option to xsgt-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> xsgt-cli " + methodname + " " + args + "\n";
}
