                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("xsightcoin Client") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a xsgt address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and xsgt: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About xsightcoin Client"), this);
    aboutAction->setStatusTip(tr("Show information about xsightcoin Client"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for xsgt"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your xsgt addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified xsgt addresses"));
    ...
    openAction->setStatusTip(tr("Open a xsgt: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the xsightcoin Client help message to get a list with possible xsgt command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("xsightcoin Client client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to xsgt network", "", count));
}
...
{
    QString strTitle = tr("xsightcoin Client"); // default title
