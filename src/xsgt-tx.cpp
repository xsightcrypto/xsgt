...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("xsightcoin Client xsgt-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  xsgt-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xsgt transaction") + "\n" +
                               "  xsgt-tx [options] -create [commands]   " + _("Create hex-encoded xsgt transaction") + "\n" +
                               "\n";
...
static void MutateTxsgtn(CMutableTransaction& tx, const string& flagStr)
{
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded xsgt transaction
