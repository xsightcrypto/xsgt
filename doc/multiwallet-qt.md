...
In order to support loading of multiple wallets in xsgt-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is xsgt.cpp.
...
Changes to xsgt.cpp
----------------------
xsgt.cpp is the entry point into xsgt-qt, and as such, will require some minor modifications to provide hooks for
