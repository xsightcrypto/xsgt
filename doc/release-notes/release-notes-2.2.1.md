xsightcoin Client version 2.2.1 is now available from:

  <https://github.com/xsgt-project/xsgt/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/xsgt-project/xsgt/issues>
...
xsightcoin Client should also work on most other Unix-like systems but is not
...
of Bitcoin that xsgt was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/xsgt-project-translations/).
