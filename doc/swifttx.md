...
This mechanism has been integrated into Bitcore-Node-xsgt which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/xsgt-Project/insight-api-xsgt#web-socket-api](https://github.com/xsgt-Project/insight-api-xsgt#web-socket-api) 
* API: [https://github.com/xsgt-Project/insight-api-xsgt#swifttx-transactions](https://github.com/xsgt-Project/insight-api-xsgt#swifttx-transactions) 
...
By default, the xsightcoin Client daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the xsightcoin Client daemon:
