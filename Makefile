...
pkgdatadir = $(datadir)/xsgt
pkgincludedir = $(includedir)/xsgt
pkglibdir = $(libdir)/xsgt
pkglibexecdir = $(libexecdir)/xsgt
...
CONFIG_HEADER = $(top_builddir)/src/config/xsgt-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/xsgt-config.h.in \
...
ACLOCAL = ${SHELL} /home/kalkulus/Scrivania/xsight-master/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/kalkulus/Scrivania/xsight-master/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/kalkulus/Scrivania/xsight-master/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/kalkulus/Scrivania/xsight-master/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/kalkulus/Scrivania/xsight-master/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = xsgt
PACKAGE_BUGREPORT = www.xsightcoincoin.org
PACKAGE_NAME = xsightcoin Client
PACKAGE_STRING = xsightcoin Client 1.0.0
PACKAGE_TARNAME = xsgt
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/kalkulus/Scrivania/xsight-master
abs_srcdir = /home/kalkulus/Scrivania/xsight-master
abs_top_builddir = /home/kalkulus/Scrivania/xsight-master
abs_top_srcdir = /home/kalkulus/Scrivania/xsight-master
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/kalkulus/Scrivania/xsight-master/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/xsgtd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/xsgt-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/xsgt-cli$(EXEEXT)
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_xsgt_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_xsgt_coverage.info test_xsgt.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/xsgt-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/xsgt-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/xsgt-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/xsgt-config.h
$(top_srcdir)/src/config/xsgt-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/xsgt-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/xsgt-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/xsgt-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/xsgt-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_xsgt.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_xsgt -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_xsgt_filtered.info: test_xsgt.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_xsgt_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_xsgt_coverage.info: baseline_filtered_combined.info test_xsgt_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_xsgt_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_xsgt_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_xsgt_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_xsgt.coverage/.dirstamp:  test_xsgt_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_xsgt.coverage/.dirstamp total.coverage/.dirstamp

# xsgt: disable the outdated comparison tool test
...
clean-local:
	rm -rf test_xsgt.coverage/ total.coverage/ $(OSX_APP)
